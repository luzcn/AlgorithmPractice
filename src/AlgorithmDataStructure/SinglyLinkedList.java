...
public class SinglyLinkedList<T>
{
	 ...
	 * 
	 * @return reverse the linked list
	 */
	 ...
	 * @return
	 */
	private LinkedNode<T> reverseInRecursive(LinkedNode<T> currentNode,
			LinkedNode<T> prev)
	{
		...
		{
			LinkedNode<T> temp = reverseInRecursive(currentNode.next,
					currentNode);
			currentNode.next = prev;
			return temp;
		}
	...
	public static void main(String[] args)
	{
		...
		SinglyLinkedList<Integer> reversedList = list
				.reverseLinkedListEveryKNode(2);
