 ...
 * 
 * 2.The first pointer is incremented through each node of the list. 
 * 	 The second pointer moves twice as fast, and skips every other node.
 * 
 * 3.If the linked list contains a loop, these two pointers will eventually meet at the same node, 
 *   thus indicating that the linked list contains a loop.
 */
